...
const leftCitiesComp = ({listCity,setToggleModal,setcityDisplay,highlight}) => {
    return (
        <div className="left">
                        ...
                        <div>
                            ...
                            }}  viewBox="64 64 896 896" focusable="false" data-icon="plus-circle" width="1em" height="1em" fill="currentColor" aria-hidden="true">
